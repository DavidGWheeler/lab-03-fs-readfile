...
describe('readFile()', function() {
  let mockDataPaths = [`${__dirname}/../data/one.txt`, `${__dirname}/../data/two.txt`, `${__dirname}/../data/three.txt`];
  ...
  it('should return hex value for two.txt', done => {
    let mockOutput = ['4865726527732061', '57686f2077617320', '54696c6c20746865'];
    eatFiles(mockDataPaths, function(err, data) {
      if (err) throw err;
